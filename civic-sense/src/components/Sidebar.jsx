        ...
        <div className="d-flex flex-column h-100">
            ...
            <div className="px-4 py-4 d-flex align-items-center justify-content-between border-bottom flex-shrink-0"
                ...
                <div className="d-flex align-items-center gap-3">
                    <img src={civicLogo} alt="Civic Connect" width="28" style={{ opacity: 0.95 }} />
                    <div>
                        <p className="fw-bold mb-0" style={{ color: 'white', fontSize: '0.88rem', letterSpacing: '0.5px' }}>Civic Connect</p>
                        <small style={{ color: 'rgba(255,255,255,0.35)', fontSize: '0.67rem', letterSpacing: '1px' }}>CITIZEN PORTAL</small>
                    </div>
                </div>
                {onClose && (
            ...
            <nav className="flex-grow-1 px-3 py-4 overflow-auto" style={{ scrollbarWidth: 'none' }}>
                <p className="text-uppercase fw-bold px-3 mb-3" style={{ fontSize: '0.62rem', color: 'rgba(255,255,255,0.3)', letterSpacing: '0.12em' }}>Menu</p>
                ...
                <button
                    className="w-100 border-0 d-flex align-items-center gap-3 px-3 py-3 mb-1"
                    ...
                    onClick={() => { navigate('/dashboard/security'); onClose?.(); }}
                    onMouseEnter={e => { e.currentTarget.style.background = 'rgba(255,255,255,0.06)'; e.currentTarget.style.color = 'rgba(255,255,255,0.8)'; }}
                    onMouseLeave={e => { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.color = 'rgba(255,255,255,0.5)'; }}
                >
                    <FaShieldAlt size={16} /><span>Privacy</span>
                </button>
            </nav>

            {/* ── User panel — dropdown ABOVE, outside overflow:hidden ── */}
            <div
                className="flex-shrink-0 border-top px-3 py-3"
                style={{ borderColor: 'rgba(255,255,255,0.07)', background: 'rgba(255,255,255,0.03)', position: 'relative' }}
                ref={dropdownRef}
            >
                {/* Dropdown rendered ABOVE the user row */}
                <AnimatePresence>
                    {isDropdownOpen && (
                        <motion.div
                        ...
                        >
                            <div className="p-2">
                                ...
                                <button onClick={() => { navigate('/dashboard/leaderboard'); onClose?.(); }}
                                    ...
                                    onMouseEnter={e => e.currentTarget.style.background = 'rgba(255,255,255,0.08)'}
                                    onMouseLeave={e => e.currentTarget.style.background = 'transparent'}>
                                    <FaTrophy size={13} /> Leaderboard
                                </button>
                                <div style={{ height: '1px', background: 'rgba(255,255,255,0.08)', margin: '6px 0' }} />
                                <button onClick={handleLogout}
                                    className="w-100 border-0 d-flex align-items-center gap-3 px-3 py-2 rounded-2"
                ...
                <div
                    ...
                    style={{ cursor: 'pointer', borderRadius: '12px', background: isDropdownOpen ? 'rgba(99,102,241,0.15)' : 'transparent', transition: 'background 0.15s' }}
                ...
                >
                    <div className="rounded-circle d-flex align-items-center justify-content-center fw-bold flex-shrink-0"
                        style={{ width: '34px', height: '34px', background: 'linear-gradient(135deg, #6366f1, #8b5cf6)', color: 'white', fontSize: '0.78rem' }}>
                        {initials}
                    </div>
                    <div className="flex-grow-1" style={{ overflow: 'hidden' }}>
                        <p className="fw-bold mb-0 text-truncate" style={{ color: 'white', fontSize: '0.82rem' }}>{user?.userName || 'User'}</p>
                        <small className="text-truncate d-block" style={{ color: 'rgba(255,255,255,0.4)', fontSize: '0.7rem' }}>Citizen</small>
                    </div>
        ...
        <>
            ...
            <div
                ...
                style={{
                    ...
                    zIndex: 200,
                    overflow: 'visible',   /* ← was 'hidden' — that clipped the upward dropdown */
                }}
            >
